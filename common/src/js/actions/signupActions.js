    ...
    return (dispatch) => {
        if (owner == "true") {
            dispatch({
                ...
                payload: axios.post('https://zs-delicious-deliveries.herokuapp.com/api/Owners', {name, email, password, phone_number})
            ...
            dispatch({
                ...
                payload: axios.post('https://zs-delicious-deliveries.herokuapp.com/api/Customers', {name, email, password, phone_number})
                .then(results => {return results.data})
                .catch(err => console.log(err))
            })
        }
