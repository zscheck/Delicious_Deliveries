...
export function updateRestaurant(food_type, name, address1, address2, city, state, zip, image, phone_number, ownerId, restaurantId) {
    ...
    return (dispatch) => {
        axios.put(`https://zs-delicious-deliveries.herokuapp.com/api/Owners/${ownerId}/restaurants/${restaurantId}`, {food_type, name, address1, address2, city, state, zip, image, phone_number})
            .then(results => {
...
export const getOwnerRestaurants = ownerId => {
    return (dispatch) => {
        ...
        axios.get(`https://zs-delicious-deliveries.herokuapp.com/api/Owners/${ownerId}/restaurants`)
        .then(res => {
